...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _jobMap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jobMap.js */ \"./js/jobMap.js\");\n/* harmony import */ var _listFilter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./listFilter.js */ \"./js/listFilter.js\");\n/* harmony import */ var _stripe_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stripe.js */ \"./js/stripe.js\");\n/* harmony import */ var _applicant_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./applicant.js */ \"./js/applicant.js\");\n/* harmony import */ var _order_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./order.js */ \"./js/order.js\");\n$(document).foundation();\n\n\n\n\n\n\n\n\n$(document).ready(function() {\n    let lfilter = new _listFilter_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](),\n        stripe = new _stripe_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"](),\n        applicant = new _applicant_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](),\n        order = new _order_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n\n    lfilter.init();\n    stripe.init();\n    applicant.init();\n    order.init();\n});\n\nfunction initMap() {\n    let jmap = new _jobMap_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    jmap.init();\n\n    window.jobMapHandle = jmap;\n}\n\nfunction updateMapMarker(event, anchor, id, isDisinterested) {\n    if (event !== null) {\n        event.preventDefault();\n    }\n    $.ajax({\n        type: 'GET',\n        url: $(anchor).attr('href')\n    }).done((response) => {\n        window.jobMapHandle.updateExistingJobMarker(id, response, isDisinterested);\n    });\n\n    return false;\n}\n\n\nwindow.initMap = initMap;\nwindow.updateMapMarker = updateMapMarker;\n\n\n//# sourceURL=webpack:///./js/app.js?");
